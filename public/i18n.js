...
export const STRINGS = {
  is: {
    ...
    'base.temp': 'Hiti',
    'base.temp.d': 'hiti í 2 m hæð, jafnhitalínur á 2°',
    'base.apparent': 'Vindkæling',
    'base.apparent.d': 'upplifaður hiti — vindur og raki taldir með',
    'base.humidity': 'Raki',
    'base.humidity.d': 'rakastig í 2 m hæð',
    'base.precip': 'Úrkoma',
    'base.precip.d': 'ákefð regns og snjókomu',
    'base.cloud': 'Ský',
    'base.cloud.d': 'heildarskýjahula',
    'base.fog': 'Þokuhætta',
    'base.fog.d': 'munur á hita og daggarmarki — lítill munur boðar þoku',
    'base.visibility': 'Skyggni',
    'base.visibility.d': 'því sterkari litur, því verra skyggni',
    'base.snowdepth': 'Snjódýpt',
    'base.snowdepth.d': 'snjódýpt á jörðu',
    'base.freezing': 'Frostmark',
    'base.freezing.d': 'hæð frostmarks yfir sjó, línur á 100 m',
    'base.none': 'Ekkert',
    'base.none.d': 'aðeins agnirnar, ekkert bakgrunnssvið',
    'legend.humidity': 'Raki',
    'legend.pressure': 'Þrýstingur',
    'legend.visibility': 'Skyggni',
    'legend.snowdepth': 'Snjódýpt',
    'legend.freezing': 'Frostmark',
    'legend.apparent': 'Vindkæling',
    'legend.fog': 'Hiti − daggarmark',
    'mg.pressure': 'Þrýstingur hPa',
    'legend.fzlLine': 'línur á 100 m',
    'toast.loadingField': 'Sæki gögn…',
    'tile.humidity': 'Raki',
    'tile.dew': 'Daggarmark',
    'tile.feels': 'Vindkæling',
    'tile.pressure': 'Þrýstingur',
    'tile.visibility': 'Skyggni',
    'tile.freezing': 'Frostmark',
    'tile.pprob': 'Úrkomulíkur',
    'tile.fog': 'Þokuhætta',
    'tile.fogNear': 'lítill munur á hita og daggarmarki',
    'tile.modelNow': 'líkan · Reykjavík',
    'sect.detail': 'Nánar · Reykjavík',
    'sect.meteogram': 'Veðurrit · 48 klst',
    'mg.temp': 'Hiti °C',
    'mg.precip': 'Úrkoma mm/klst',
    'mg.wind': 'Vindur m/s',
    'mg.note': 'Líkanið fyrir Reykjavík. Skyggða svæðið er hviður, línan meðalvindur.',
    'mg.tempLine': 'hiti',
    'mg.appLine': 'vindkæling',
    'mg.windLine': 'meðalvindur',
    'mg.gustBand': 'hviður',

    'legend.temp': 'Hiti',
    'legend.precipTitle': 'Úrkoma',
    'legend.cloudTitle': 'Skýjahula',
    'legend.freezingLine': 'frostlína 0°',
  ...
  en: {
    ...
    'base.temp': 'Temp',
    'base.temp.d': '2 m temperature, isotherms every 2°',
    'base.apparent': 'Feels like',
    'base.apparent.d': 'apparent temperature — wind and humidity included',
    'base.humidity': 'Humidity',
    'base.humidity.d': '2 m relative humidity',
    'base.precip': 'Rain',
    'base.precip.d': 'rain and snow rate',
    'base.cloud': 'Cloud',
    'base.cloud.d': 'total cloud fraction',
    'base.fog': 'Fog risk',
    'base.fog.d': 'temperature minus dew point — a small gap means fog',
    'base.visibility': 'Visibility',
    'base.visibility.d': 'stronger colour means worse visibility',
    'base.snowdepth': 'Snow depth',
    'base.snowdepth.d': 'snow lying on the ground',
    'base.freezing': 'Freezing level',
    'base.freezing.d': 'height of the 0° line, contours every 100 m',
    'base.none': 'None',
    'base.none.d': 'particles only, no background field',
    'legend.humidity': 'Humidity',
    'legend.pressure': 'Pressure',
    'legend.visibility': 'Visibility',
    'legend.snowdepth': 'Snow depth',
    'legend.freezing': 'Freezing level',
    'legend.apparent': 'Feels like',
    'legend.fog': 'Temp − dew point',
    'mg.pressure': 'Pressure hPa',
    'legend.fzlLine': 'contours every 100 m',
    'toast.loadingField': 'Loading field…',
    'tile.humidity': 'Humidity',
    'tile.dew': 'Dew point',
    'tile.feels': 'Feels like',
    'tile.pressure': 'Pressure',
    'tile.visibility': 'Visibility',
    'tile.freezing': 'Freezing level',
    'tile.pprob': 'Chance of rain',
    'tile.fog': 'Fog risk',
    'tile.fogNear': 'temperature close to dew point',
    'tile.modelNow': 'model · Reykjavík',
    'sect.detail': 'Detail · Reykjavík',
    'sect.meteogram': 'Meteogram · 48 h',
    'mg.temp': 'Temp °C',
    'mg.precip': 'Rain mm/h',
    'mg.wind': 'Wind m/s',
    'mg.note': 'Model at Reykjavík. The band is gusts, the line is mean wind.',
    'mg.tempLine': 'temp',
    'mg.appLine': 'feels like',
    'mg.windLine': 'mean',
    'mg.gustBand': 'gusts',
    ...
    'legend.freezingLine': 'freezing line 0°',
